        ...
        try:
            if s_port in d_port_info.keys() :
                ...
                try:
                    ...
                    l_item.append('No_IP')
                    if (d_port_info[s_port]["vlan"] > 1000) and (d_port_info[s_port]["vlan"] < 2000):
                        l_item.append('IPNet')
                    elif (d_port_info[s_port]["vlan"] > 2000) :
                        l_item.append('DCN')
                    else:
                        l_item.append('Burwest')
                if '09IR' in line:
                    l_item.append('Norwest')
                else:
                    l_item.append('Burwood')
